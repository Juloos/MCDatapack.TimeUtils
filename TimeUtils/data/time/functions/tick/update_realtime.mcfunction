execute as @e if score @s time.realtime.mode matches 1 unless score @s time.realtime matches ..0 run scoreboard players operation @s time.realtime += systime.delta time.vars
execute as @e if score @s time.realtime.mode matches 2 run scoreboard players operation @s time.realtime -= systime.delta time.vars
